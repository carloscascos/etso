...
class ObservatorioDashboard {
        ...
        return `
            <div class="theme-item" data-theme-id="${theme.id}">
                <div class="theme-item-header">
                    <span class="theme-id">
                        ${theme.id}: ${theme.theme_title || `Theme ${theme.id}`}
                    </span>
    ...
    displayResearchDetails(research) {
        ...
        // Update research title with theme title
        const titleText = metadata.theme_title 
            ? `${metadata.id}: ${metadata.theme_title}`
            : `Research ${metadata.id}: ${metadata.theme_type.toUpperCase()}`;
        document.getElementById('research-title').textContent = titleText;
